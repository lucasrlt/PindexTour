...
public abstract class Hilt_ExperienceFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ExperienceFragment() {
    super();
  }

  Hilt_ExperienceFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ExperienceFragment_GeneratedInjector) this.generatedComponent()).injectExperienceFragment(UnsafeCasts.<ExperienceFragment>unsafeCast(this));
    }
  }
